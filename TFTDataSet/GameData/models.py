...
class ItemizedUnit(models.Model):
    ...
    item_1     = models.ForeignKey(Item, on_delete=models.CASCADE, related_name='first_item')
    item_2     = models.ForeignKey(Item, on_delete=models.CASCADE, related_name='second_item')
    item_3     = models.ForeignKey(Item, on_delete=models.CASCADE, related_name='third_item')
...
class Game(models.Model):
    ...
    augment_3             = models.ForeignKey(Augment, on_delete=models.CASCADE, related_name='third_augment')

    carry_unit            = models.ForeignKey(ItemizedUnit, on_delete=models.CASCADE, related_name='first_carry')
    secondary_carry_unit  = models.ForeignKey(ItemizedUnit, on_delete=models.CASCADE, related_name='secondary_carry')
    tank                  = models.ForeignKey(ItemizedUnit, on_delete=models.CASCADE, related_name='primary_tank')
